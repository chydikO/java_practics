...
public class Task00
{
    ...
    {
        String s = null; // строка является ссылочным типом и может принимать значение литерала null

        // TODO только ссылочные переменные могут принимать значение литерала
        // null
